...
const SecondLorem = (props) => {
  return (
      <div id='second-lorem-outer-container'> 
         <div id='second-lorem-inner-container'>
            <div>
               <p id="second-lorem-title">LOREM IPSUM</p>
            </div>
            <div id="second-lorem-paragraph-container">
               <p id="second-lorem-paragraph">
            ...
            <div>
               <p id="second-lorem-link"> &gt; Lorem Ipsum</p>
            </div>
         </div>
      </div>
   )}
